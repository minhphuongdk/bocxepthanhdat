...
if ( file_exists( dirname( __FILE__ ) . '/local-config.php' ) ) {
	...
	$url = parse_url(getenv("mysql://be7e167872cbe4:f92023fc@eu-cdbr-west-02.cleardb.net/heroku_7a6d5c3867997ff?reconnect=true"));

	/** The name of the database for WordPress */
	define("DB_NAME", trim($url["heroku_7a6d5c3867997ff"]));

	/** MySQL database username */
	define("DB_USER", trim($url["be7e167872cbe4"]));

	/** MySQL database password */
	define("DB_PASSWORD", trim($url["f92023fc"]));
